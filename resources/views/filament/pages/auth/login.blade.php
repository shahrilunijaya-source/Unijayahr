...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/css/filament/app/theme.css', 'resources/js/app.js'])
</head>
<body>
    <div class="hr-login-container">
        @include('filament.partials.login-panel-left')

        <div class="hr-login-right">
            <div class="hr-login-form-wrapper">
                <h1 class="hr-login-heading">Portal HR Unijaya</h1>
                <p class="hr-login-sub">Masuk dengan akaun anda</p>

                <x-filament-panels::form id="form" wire:submit="authenticate" class="mt-6">
                    {{ $this->form }}
